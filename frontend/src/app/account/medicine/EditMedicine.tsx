...
const EditMedicine = () => {
  ...
  return (
    <div className='my-5 py-10 px-5 '>
      <h1 className="flex justify-center mx-auto font-sans font-semibold text-lg md:text-2xl text-black/70">Edit Medicine   </h1>
            ...
            <label htmlFor="licenseFile" className="flex flex-col items-center justify-center w-full md:w-1/2 h-54 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-gray-100">
              { !imageUrl ?
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="mb-2 text-center text-xs md:text-sm text-gray-500 dark:text-gray-400"><span className="text-center font-semibold">Click to upload the medicine photo</span> or drag and drop</p>
